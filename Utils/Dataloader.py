...
class PopMFRatingDataset(Dataset):
    def __init__(self, uid, iid, rating, pop):
        self.uid = uid
        self.iid = iid
        self.rating = rating
        self.pop = pop
    ...
    def __getitem__(self, index):
        ...
        return self.uid[index], self.iid[index], self.rating[index], self.pop[self.iid[index]]
...
class Debias_TrainingDataset(Dataset):
...
class Pop_TrainingDataset(Dataset):
    def __init__(self, Y_data, O_data, Feature, PopValue):
        self.Y_data = Y_data
        self.O_data = O_data
        self.Feature = Feature
    ...
    def __getitem__(self, index):
        return self.Y_data[index], self.O_data[index], self.Feature[index], self.PopValue[index]

    def __len__(self):
        return len(self.Y_data)

class Pop_TrainingDataset_WtFeature(Dataset):
    def __init__(self, Y_data, O_data, PopValue):
        self.Y_data = Y_data
        self.O_data = O_data
        self.PopValue = PopValue

    def __getitem__(self, index):
        return self.Y_data[index], self.O_data[index], self.PopValue[index]
